...
//	final static String DBURL = "jdbc:sqlite:public_wifi.db";
	...
	// for test db
//    String url = "jdbc:mariadb://13.125.25.238:3306/testdb1";
...
//    String dbPassword = "test1234";
	...
	public void createTable() {
		...
		try {
			...
			createTableSQL = "CREATE TABLE IF NOT EXISTS location_history ("
					...
					+ ")";
			stmt.execute(createTableSQL);
			System.out.println("location_history 테이블 생성 완료");
...
//                		+ "(latitude, longitude, remarks3, installationFloor, workDatetime, "
//                		+ "managerNo, cmcwr, installationBy, inOutDoor, mainName, district, installationType, "
//                		+ "serviceType, address1, address2, constructionYear) "
//                		+ "values  (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
...
//            long listTotalCount = 10;
	...
	public List<WifiInfo> getWifiNearBy(Double lat, Double lnt) { // lat: 위도, lnt: 경도
		// 34.4811992 , 126.8955438
		// 37.532544, 126.865596
		List<WifiInfo> WifiList = new ArrayList<WifiInfo>();
